# [![luma-logo](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/assets/logo.svg)](https://lumalabs.ai) Luma WebGL Library
...
**Request features and report bugs on our [![github-logo](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/assets/images/github-mark-16.svg) GitHub repo](https://github.com/lumalabs/luma-web-library)** 

### Contents
- [Getting Started](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#getting-started)
- [Background Removal](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#background-removal)
- [Three Fog](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#three-fog)
- [Scene Lighting](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#scene-lighting)
- [Custom Shaders](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#custom-shaders)
- [React Three Fiber](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#react-three-fiber)
- [Transmission](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#transmission)
- [VR](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#vr)

## Getting Started
[![hello-world-demo](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/assets/images/hello-world-preview.jpg)](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#getting-started)
...
**[minimal.html](https://github.com/lumalabs/luma-web-library/blob/fefe154/src/minimal.html)**
```html
<canvas></canvas>
...
**[DemoHelloWorld.ts](https://github.com/lumalabs/luma-web-library/blob/fefe154/src/DemoHelloWorld.ts)**
```ts
...
## Background Removal
[![background-removal-demo](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/assets/images/background-removal-preview.jpg)](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#background-removal)
...
**[DemoBackgroundRemoval.ts](https://github.com/lumalabs/luma-web-library/blob/fefe154/src/DemoBackgroundRemoval.ts)**
```ts
...
## Three Fog
[![three.js-fog-demo](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/assets/images/three.js-fog-preview.jpg)](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#three-fog)
...
**[DemoFog.ts](https://github.com/lumalabs/luma-web-library/blob/fefe154/src/DemoFog.ts)**
```ts
...
## Scene Lighting
[![scene-lighting-demo](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/assets/images/scene-lighting-preview.jpg)](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#scene-lighting)
...
**[DemoLighting.ts](https://github.com/lumalabs/luma-web-library/blob/fefe154/src/DemoLighting.ts)**
```ts
let splats = new LumaSplatsThree({
...
## Custom Shaders
[![custom-shaders-demo](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/assets/images/custom-shaders-preview.jpg)](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#custom-shaders)
...
**[DemoCustomShaders.ts](https://github.com/lumalabs/luma-web-library/blob/fefe154/src/DemoCustomShaders.ts)**
```ts
...
## React Three Fiber
[![react-three-fiber-demo](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/assets/images/react-three-fiber-preview.jpg)](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#react-three-fiber)
...
**[DemoReactThreeFiber.tsx](https://github.com/lumalabs/luma-web-library/blob/fefe154/src/DemoReactThreeFiber.tsx)**
```typescript
...
## Transmission
[![transmission-demo](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/assets/images/transmission-preview.jpg)](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#transmission)
...
**[DemoTransmission.ts](https://github.com/lumalabs/luma-web-library/blob/fefe154/src/DemoTransmission.ts)**
```typescript
// inner splat
...
## VR
[![vr-demo](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/assets/images/vr-preview.jpg)](https://cdn-luma.com/public/lumalabs.ai/luma-web-library/0.2/fefe154/index.html#vr)
...
**[DemoVR.ts](https://github.com/lumalabs/luma-web-library/blob/fefe154/src/DemoVR.ts)**
```typescript
